export const SERVICE_KEYS = [
  ...
  { key: 'service_website_build', label: 'Website Build', color: '#14b8a6', icon: '🌐' },
];

export const CLIENT_STATUSES = ['lead', 'prospect', 'client', 'churned', 'lost'];
...
export const STATUS_COLORS = {
  ...
  churned: '#64748b',
  lost: '#ef4444',
  // legacy values — kept for any data that hasn't migrated
  Active: '#10b981',
  Paused: '#f59e0b',
  Churned: '#64748b',
  Lead: '#3b82f6',
...
export const TASK_STATUSES = ['Not Started', 'In Progress', 'Pending Client Approval', 'Done', 'Snoozed', 'Archived'];
